...
let g:omni#palette.comment   = ['#483C67',  61]
let g:omni#palette.selection = ['#41414D', 239]
let g:omni#palette.subtle    = ['#201B2D', 238]

let g:omni#palette.cyan      = ['#78D1E1', 120]
let g:omni#palette.green     = ['#67e480',  103]
let g:omni#palette.orange    = ['#E89E64', 232]
let g:omni#palette.pink      = ['#FF79C6', 212]
let g:omni#palette.purple    = ['#988BC7', 141]
